...
import { createDocument, createFolder, getFolders, getDocuments } from '../../services/api';

const DebugUploadTest = ({ user }) => {
  ...
  const testFolderCreation = async () => {
    ...
    if (user.role === 'EMPLOYEE') {
      addResult('warning', 'Employee users do not have permission to create folders.');
      return;
    }
